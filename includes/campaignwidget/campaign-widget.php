...
class CampaignWidget {
    ...
    public function email_campaign_widget_display_meta_box($post){
		...
		?>
            ...
            <div id="div_email_campaign_widget">
                <label>
                    <input type="checkbox" id="email_campaign_widget" name="email_campaign_widget" value="true" <?php if ($email_campaign_widget_checked) {
                        echo 'checked';
                    } ?>></input>
            ...
            <div id="email_campaign_widget_preferences" style="padding-bottom:10px;">
                <input type="checkbox" id="email_campaign_widget_modify_content" value="true" name="email_campaign_widget_modify_content" <?php if ($email_campaign_widget_custom_contents_checked) {
                        echo 'checked';
                ...
                <div id="email_campaign_widget_custom_contents" style="display:none;padding-top:10px;">
                    <div >
                        <label><?php _e('Campaign Title', 'egoi-for-wp'); ?><br/>
                            <input type="text" size="16"  name="email_campaign_widget_custom_heading" value="<?php 
                    ...
                    <div>
                        <label><?php _e('Campaign Subject', 'egoi-for-wp'); ?><br/>
                            <input type="text" size="16"  name="email_campaign_widget_custom_content" value="<?php 
            ...
            <div>                    
                ...
                <div id="div_webpush_campaign_widget">
                    <label>
                        <input type="checkbox" id="webpush_campaign_widget" name="webpush_campaign_widget" value="true" <?php if ($webpush_campaign_widget_checked) {
                            echo 'checked';
                        } ?>></input>
                ...
                <div id="webpush_campaign_widget_preferences">
                    <input type="checkbox" id="webpush_campaign_widget_modify_content" value="true" name="webpush_campaign_widget_modify_content" <?php if ($webpush_campaign_widget_custom_contents_checked) {
                            echo 'checked';
                    ...
                    <div id="webpush_campaign_widget_custom_contents" style="display:none;padding-top:10px;">
                        <div>
                            <label><?php _e('Campaign Title', 'egoi-for-wp'); ?><br/>
                            <input type="text" size="16"  name="webpush_campaign_widget_custom_heading" value="<?php 
                        ...
                        <div>
                            <label><?php _e('Campaign Subject', 'egoi-for-wp'); ?><br/>
                            <input type="text" size="16"  name="webpush_campaign_widget_custom_content" value="<?php 
    ...
    public function create_email_campaign($post){
        ...
        $body = array(
            ...
            'internal_name' => $title,
            'subject' => $title,
            'content' => array('type' => 'html', 'body' => $this->get_email_html_template($title, $content, $thumbnail, $blog_info)),
    ...
    public function create_webpush_campaign($post){
        ...
        $body = array(
            ...
            'internal_name' => $title,
            'content' => array('title' => $title, 'message' => $content, 'link' => $link),
        );
