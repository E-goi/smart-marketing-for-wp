...
class Egoi_For_Wp_Public {
	...
	*/
    ...
    public function egoi_rss_feeds_content() {
        $feed_configs = get_option($_GET['feed']);
        ...
        while ( $query->have_posts() ) : $query->the_post();
            ...
            foreach ($words as $word) {
                ...
                $words_num++;
                if ($char_num >= $feed_configs['max_characters']) {
                    break;
                }
            }
            ?>
            <item>
                ...
                <?php endif; ?>
                <pubDate><?php echo mysql2date('d M Y H:i', get_post_time('Y-m-d H:i:s', true), false); ?></pubDate>
