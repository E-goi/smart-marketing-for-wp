jQuery(document).ready(function($) {
	...
	'use strict';
		...
		//header
		$('#smart-marketing-egoi').on('click', '#tab_egoi', function() {
		...
		//footer
		$('#smart-marketing-egoi').on('click', '#tab_egoi_footer', function() {
			if($('#egoi-bar').is(":visible")){	
		...
		//when fixed
		$('#smart-marketing-egoi').on('click', '#tab_egoi_footer_fixed', function() {
			if($('#egoi-bar').is(":visible")){
				$(this).addClass('egoi-bottom-open-action');
				$(this).removeClass('egoi-bottom-close-action');
		...
		// BAR GENERATION
		$('#smart-marketing-egoi').on('click', '#tab_egoi_submit_close', function(){
		...
		// BAR SUBSCRIPTION 
		$('#smart-marketing-egoi').on('click', 'input.egoi_sub_btn', function() {
