		...
		<?php if ( class_exists( 'WooCommerce' ) ) { ?>
            ...
            <div class="egoi-sub-form-ident">
                <div class="smsnf-input-group">
                    ...
                    <p class="subtitle"><?php _e( "When enabled, this option processes all orders via Backend (API). If disabled, orders will be processed via the Track&Engage script.", 'egoi-for-wp' ); ?></p>
