		...
		<section class="smsnf-content">
			<div class="d-flex align-items-start">
				<div class="nav flex-column nav-pills me-3 egoinav" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button disabled class="nav-link" id="v-pills-orders-tab" data-bs-toggle="pill" data-bs-target="#v-pills-orders" type="button" role="tab" aria-controls="v-pills-orders" aria-selected="false"><span><?php _e( 'Orders', 'egoi-for-wp' ); ?></span></button>
				...
				<div class="tab-content" id="v-pills-tabContent" style="display: flex;">
                    ...
                    require_once plugin_dir_path( __FILE__ ) . 'wizard/orders.php';
