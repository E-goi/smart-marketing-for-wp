...
?>
    <div id="smsnf-configuration" class="smsnf-tab-content smsnf-grid active">
        <div>
            ...
            <div class="smsnf-input-group">
                ...
                <input id="text-bar" type="text" name="egoi_bar_sync[text_bar]" value="<?php echo $this->bar_post['text_bar']; ?>" autocomplete="off" />
            </div>
            <!-- / BAR TEXT -->
            <!-- BTN TEXT -->
            <div class="smsnf-input-group">
        ...
        <div>
            ...
            <div class="smsnf-input-group">
                ...
                <div class="colorpicker-wrapper">
                    ...
                    <input id="bar-background-color" type="text" name="egoi_bar_sync[color_bar]" value="<?php echo esc_attr( $this->bar_post['color_bar'] ) ?>"  autocomplete="off" />
            ...
            <div class="smsnf-input-group">
                ...
                <div class="colorpicker-wrapper">
                    ...
                    <input id="bar-text-color" type="text" name="egoi_bar_sync[bar_text_color]" value="<?php echo  esc_attr( $this->bar_post['bar_text_color'] ) ?>"  autocomplete="off" />
                    <p><?php _e( 'Select Color', 'egoi-for-wp' ) ?></p>
                </div>
            </div>
            <!-- / TEXT COLOR -->
            ...
            <div class="smsnf-input-group">
                ...
                <input  id="bar-border-size" type="text" name="egoi_bar_sync[border_px]" value="<?php echo  esc_attr( $this->bar_post['border_px'] ); ?>" autocomplete="off" />
            </div>
            <!-- / BORDER SIZE -->
            <!-- BORDER COLOR -->
            <div class="smsnf-input-group">
                ...
                <div class="colorpicker-wrapper">
                    ...
                    <input id="bar-text-color" type="text" name="egoi_bar_sync[border_color]" value="<?php echo  esc_attr( $this->bar_post['border_color'] ) ?>"  autocomplete="off" />
                    <p><?php _e( 'Select Color', 'egoi-for-wp' ) ?></p>
                </div>
            </div>
            <!-- / BORDER COLOR -->
            ...
            <div class="smsnf-input-group">
                ...
                <div class="colorpicker-wrapper">
                    ...
                    <input id="bar-text-color" type="text" name="egoi_bar_sync[color_button]" value="<?php echo  esc_attr( $this->bar_post['color_button'] ) ?>"  autocomplete="off" />
                    <p><?php _e( 'Select Color', 'egoi-for-wp' ) ?></p>
                </div>
            </div>
            <!-- / BTN COLOR -->
            ...
            <div class="smsnf-input-group">
                ...
                <div class="colorpicker-wrapper">
                    ...
                    <input id="bar-text-color" type="text" name="egoi_bar_sync[color_button_text]" value="<?php echo  esc_attr( $this->bar_post['color_button_text'] ) ?>"  autocomplete="off" />
                    <p><?php _e( 'Select Color', 'egoi-for-wp' ) ?></p>
                </div>
            </div>
            <!-- / BTN TEXT COLOR -->
            ...
            <div class="smsnf-input-group">
                ...
                <div class="colorpicker-wrapper">
                    ...
                    <input id="bar-text-color" type="text" name="egoi_bar_sync[success_bgcolor]" value="<?php echo  esc_attr( $this->bar_post['success_bgcolor'] ) ?>"  autocomplete="off" />
                    <p><?php _e( 'Select Color', 'egoi-for-wp' ) ?></p>
                </div>
            </div>
            <!-- / SUBMIT - SUCCESS -->
            ...
            <div class="smsnf-input-group">
                ...
                <div class="colorpicker-wrapper">
                    ...
                    <input id="bar-text-color" type="text" name="egoi_bar_sync[error_bgcolor]" value="<?php echo  esc_attr( $this->bar_post['error_bgcolor'] ) ?>"  autocomplete="off" />
                    <p><?php _e( 'Select Color', 'egoi-for-wp' ) ?></p>
                </div>
            </div>
            <!-- / SUBMIT - ERROR -->
    ...
    <div id="smsnf-messages" class="smsnf-tab-content">
        ...
        <div class="smsnf-input-group">
            ...
            <input id="subscribed-msg" type="text" name="egoi_bar_sync[text_subscribed]" value="<?php echo  esc_attr($this->bar_post['text_subscribed'] ?: __('Success Subscribed', 'egoi-for-wp')); ?>" autocomplete="off" />
        </div>
        <!-- / SUCCESS -->
        <!-- INVALID EMAIL -->
        <div class="smsnf-input-group">
            <label for="invalid-email-msg"><?php _e( 'Invalid email address', 'egoi-for-wp' ); ?></label>
            <input id="invalid-email-msg" type="text" name="egoi_bar_sync[text_invalid_email]" value="<?php echo  esc_attr($this->bar_post['text_invalid_email'] ?: __('Invalid e-mail', 'egoi-for-wp')); ?>" autocomplete="off" />
        </div>
        <!-- / INVALID EMAIL -->
        <!-- Already subscribed -->
        <div class="smsnf-input-group">
            <label for="already-subscribed-msg"><?php _e( 'Already subscribed', 'egoi-for-wp' ); ?></label>
            <input id="already-subscribed-msg" type="text" name="egoi_bar_sync[text_already_subscribed]" value="<?php echo  esc_attr($this->bar_post['text_already_subscribed'] ?: __('Subscriber already exists', 'egoi-for-wp')) ?>" autocomplete="off" />
        </div>
        <!-- / Already subscribed -->
        ...
        <div class="smsnf-input-group">
            ...
            <input id="wating_for_confirmation-msg" type="text" name="egoi_bar_sync[text_waiting_for_confirmation]" value="<?php echo  esc_attr($this->bar_post['text_waiting_for_confirmation'] ?: __('Already subscribed and waiting for confirmation e-mail', 'egoi-for-wp')) ?>" autocomplete="off" />
        </div>
        <!-- / Waiting for confirmation -->
        ...
        <div class="smsnf-input-group">
            ...
            <input id="bar-other-errors-msg" type="text" name="egoi_bar_sync[text_error]" placeholder="<?php _e( 'Eg. List Missing from E-goi', 'egoi-for-wp' );?>" value="<?php echo  esc_attr($this->bar_post['text_error']) ?>" autocomplete="off" />
        </div>
        <!-- / Other errors -->
        <!-- Redirect URL -->
        <div class="smsnf-input-group">
            <label for="bar-redirect-url"><?php _e( 'Redirect to URL after successful sign-up', 'egoi-for-wp' ); ?></label>
            <input id="bar-redirect-url" type="text" name="egoi_bar_sync[redirect]" value="<?php echo  esc_url($this->bar_post['redirect']) ?>" placeholder="<?php echo  esc_url( $this->bar_post['redirect'] ); ?>" autocomplete="off" />
