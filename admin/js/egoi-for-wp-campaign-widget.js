// Email Campaing
jQuery('#email_campaign_widget_modify_content').change( function() {
...
jQuery("#email_campaign_widget").change( function() {
if(jQuery(this).is(":checked")) {
...
//WebPush Campaign
jQuery('#webpush_campaign_widget_modify_content').change( function() {
    if(jQuery(this).is(":checked")) {              
...
jQuery("#webpush_campaign_widget").change( function() {
if(jQuery(this).is(":checked")) {
